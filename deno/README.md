...
[![Doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sqlite-regex@0.2.3-alpha.10/mod.ts)
...
import * as sqlite_regex from "https://deno.land/x/sqlite_regex@v0.2.3-alpha.10/mod.ts";
